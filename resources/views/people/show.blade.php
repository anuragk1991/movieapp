...
@section('content')
	<div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $person['profile_pic'] }}" alt="profile image" class="w-76">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-2"> {{ $person['dob'] }} (46 years old) in {{ $person['place_of_birth'] }}</span>
                </div>
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                @foreach($credits as $credit)
                    <li>
                        ...
                        <strong><a href="#" class="hover:underline">Matrix</a></strong>
                         as {{ $credit['character'] }}
                     </li>
                @endforeach
